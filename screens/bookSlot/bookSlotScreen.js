...
import { View, ScrollView, TouchableOpacity, FlatList, Dimensions, Image, StyleSheet, Text, TextInput } from "react-native";
        ...
        return (
            <View style={{ marginTop: Sizes.fixPadding + 5.0 }}>
                ...
                <View style={styles.paymentAcceptedOptionsWrapStyle}>
                    ...
                    {paymentOptionsShort({
                        paymentIcon: require('../../assets/images/paymentIcons/mpesa.png'),
            ...
            <View style={{ margin: Sizes.fixPadding * 2.0, }}>
                ...
                <View style={styles.carDetailWrapStyle}>
                    <View style={{ flex: 1, }}>
                        <TextInput
                            style={{
                                ...Fonts.blackColor14Regular, borderWidth: 2, borderColor: '#E6E6E6', borderRadius: Sizes.fixPadding, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: Sizes.fixPadding, paddingVertical: Sizes.fixPadding - 5.0, paddingRight: Sizes.fixPadding - 5.0, ...CommonStyles.shadow
                            }}
                            value={carName}
                ...
                <View style={[styles.selectVehicalTitleWrapStyle, { marginTop: 20 }]}>
                    <Text style={{ ...Fonts.blackColor16Regular }}>
                        Telephone No.
                    </Text>
                </View>
